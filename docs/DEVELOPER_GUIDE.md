...
|-------|-------|
| **Versiyon** | 2.4.4 |
| **Son Guncelleme** | 2026-05-05 |
| **Son Commit** | c9cbf66 |
| **Frontend** | 80313 satir TypeScript/TSX |
| **Backend** | 16193 satir Rust |
| **Bilesenler** | 99 React component |
| **Servisler** | 56 TypeScript servisi |
| **Hook'lar** | 25 React hook |
| **Rust Modulleri** | 28 modül |
| **Tauri Komutlari** | 137+ komut |
| **Diller** | 5 (tr, en, zh, ja, ar) |
| **Veritabani Tablolari** | 26 tablo |
<!-- AUTO-UPDATE-END -->
...
| **database.ts** (ek) | — | Proje durumu + iliskiler | `updateAssetFields` (upsert'ten bagimsiz), `addAssetRelation`, `removeAssetRelation`, `getRelationsForAsset`, `detectAndSaveSameStemRelations` |
...
*Son elle guncelleme: 2026-05-05 · Surum: 2.4.4*
