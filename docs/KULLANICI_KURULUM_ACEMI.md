...
2. **Assets** başlığı altındaki dosyalardan şunu indirin:
   - **`ArchivistPro_3.7.0_x64-setup.exe`** ← Önerilen
   - `ArchivistPro_3.7.0_x64_en-US.msi` ← Alternatif (makine düzeyine **ayrı** kopya
...
1. İndirdiğiniz **`ArchivistPro_3.7.0_x64-setup.exe`** dosyasına çift tıklayın.
...
> ℹ️ Program açılınca sol üstte, başlığın yanında sürüm numarasını (**v3.7.0**)
...
ArchivistPro 3.2.2 ve öncesi **eski nesil** bir programdır; 3.7.0 onun yerine
...
*Bu rehber programla birlikte güncellenir. Son güncelleme: 2026-08-20 (v3.7.0).*
