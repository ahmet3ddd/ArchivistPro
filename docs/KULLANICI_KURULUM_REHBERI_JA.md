...
> **バージョン:** 3.3.3 · **更新日:** 2026-08-14 · **プラットフォーム:** Windows 10/11 (64-bit)
>
...
1. **ダウンロード:** [Releases ページ](https://github.com/ahmet3ddd/ArchivistPro/releases/latest)
   から **`ArchivistPro_3.3.3_x64-setup.exe`** を入手します (推奨インストーラー。
...
5. **旧バージョンからの移行?** ArchivistPro 3.2.2 (旧世代) がインストール済みの
   場合、3.3.3 は**並行して**インストールされます。旧バージョンを**アンインストール
