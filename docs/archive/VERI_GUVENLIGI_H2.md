> ⚠️ **TARIHSEL BELGE** — eski nesil kod tabani (3.2.x hatti) donemi. Icerik o donemin durumunu anlatir ve guncel surumu YANSITMAZ. Guncel belge: docs/ kokundeki ayni adli dosya.
