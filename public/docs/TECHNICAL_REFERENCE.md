...
> Son güncelleme: 2026-05-05 (rev.11) | Versiyon: 2.4.4
...
│  │  TypeScript  │    │  State Mgmt  │    │  SQLite DB   │ │
│  │  Tailwind 4  │    └──────────────┘    └──────────────┘ │
│  └──────┬───────┘                                         │
│         │ Tauri invoke / IPC                              │
│  ┌──────▼───────┐                                         │
...
### embeddings
Vektör depolama (384d text, 512d vision).

### text_chunks
Paragraf bazlı metin parçaları (OCR, PDF, DWG text).
...
### Tarayıcı İçi Modeller (Gizlilik — veri dışarı çıkmaz)
...
|-----------|----------|---------|
| Ollama (lokal) | LLaVA/Moondream vision analizi, OCR | 90s (invokeWithTimeout) |
...
- FAISS/HNSW vektör indeksi (10K+ chunk ölçeklendirme)
- LAN TLS şifreleme
- Authenticode code signing

---

*Bu doküman ArchivistPro geliştirme sürecinde güncellenmektedir. Son güncelleme: 2026-05-05 (v2.4.4)*
