// DXF/CFBF ikili parser'ı: match kolu + iç `if` deseni bilinçli. clippy::
// collapsible_match pattern-guard'a çevirmeyi önerir; guard-fallthrough semantiği
// davranışı değiştirebilir, kozmetik lint → modül genelinde kapalı.
