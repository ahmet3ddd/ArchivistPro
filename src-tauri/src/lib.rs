...
macro_rules! shared_handlers {
    () => {
        tauri::generate_handler![
            ...
            shapes_db::init_shapes_db,
            shapes_db::persist_dwg_shapes,
            shapes_db::persist_dwg_shapes_batch,
            shapes_db::delete_dwg_shapes,
            shapes_db::query_dwg_shape_max_indexed,
            shapes_db::clear_all_dwg_shapes,
            shapes_db::get_dwg_shape_stats,
            ...
            vec_db::vec_db_migrate_embeddings,
            vec_db::vec_db_verify_embeddings,
            vec_db::vec_db_progress,
            vec_db::vec_db_count,
            vec_db::vec_db_chunk_embeddings,
            vec_db::vec_db_fts_search,
            vec_db::vec_db_embedding_stats,
            vec_db::vec_db_embeddings_by_source,
            vec_db::vec_db_chunk_embeddings_by_assets,
            vec_db::vec_db_chunks_by_ids,
            vec_db::vec_db_chunks_by_asset,
            vec_db::vec_db_chunk_count,
            vec_db::vec_db_asset_relations,
            vec_db::vec_db_rag_index_counts,
            vec_db::vec_db_chunk_stats,
            vec_db::vec_db_body_chunk_counts,
            vec_db::vec_db_metadata_chunk_asset_ids,
            vec_db::vec_db_delete_metadata_chunks,
            vec_db::vec_db_export_assets,
            vec_db::vec_db_import_assets,
            vec_db::vec_db_cascade_delete,
            vec_db::vec_db_migrate_text_chunks,
            vec_db::vec_db_verify_text_chunks,
            vec_db::vec_db_migrate_asset_relations,
            vec_db::vec_db_verify_asset_relations,
            vec_db::safety::vec_db_rollback,
            vec_db::safety::vec_db_premigrate_backup,
            vec_db::safety::vec_db_finalize_main_migration,
            vec_db::safety::vec_db_purge_orphans,
            vector_index::vector_index_rebuild,
            scan_db::favorite_apply_changes,
            scan_db::collection_apply_changes,
            scan_db::tag_apply_changes,
            scan_db::root_group_apply_changes,
            ...
            ollama_db::read_local_database_binary,
            ...
            write_system_log,
            fp32_models::fp32_models_status,
            fp32_models::import_fp32_models,
