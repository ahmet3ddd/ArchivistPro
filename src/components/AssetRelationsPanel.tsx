...
import {
    addAssetRelation, removeAssetRelation, getRelationsForAssetAsync, getAllAssets,
...
export default function AssetRelationsPanel({ asset, onLinkClick }: AssetRelationsPanelProps) {
    ...
    // V3 PRE-5e: epoch>=3'te asset_relations vec.db'de → async routing.
    const loadRelations = useCallback(() => {
        void getRelationsForAssetAsync(asset.id).then(setRelations);
    }, [asset.id]);
