...
import { getAllAssets, detectAndSaveSameStemRelations } from '../services/database';
...
export default function SourceFoldersPanel({
  ...
  const handleScanRelations = useCallback(() => {
    const allAssets = getAllAssets();
    const count = detectAndSaveSameStemRelations(allAssets);
