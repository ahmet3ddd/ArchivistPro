...
function turkishDocuments(isAdmin: boolean): Record<TabId, Article> {
  ...
  return {
    ...
    changelog: { title: "Bu sürümde", intro: "H3 arayüzündeki güncel kullanıcı odaklı iyileştirmeler.", sections: [
      ...
      { id: "filters-and-ai", title: "Filtreler ve AI", paragraphs: ["Kayıtlı filtreler filtre sisteminin parçasıdır; Favoriler isteğe bağlı bir filtre olarak açılıp kapatılabilir. AI görsel analiz durumu da tümü / analiz edilmiş / analiz edilmemiş seçenekleriyle sonuç sayılarını gösterir."]},
