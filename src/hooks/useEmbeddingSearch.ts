...
import { getAllChunkEmbeddings, searchTextChunksByKeywordAsync } from '../services/database';
  ...
  useEffect(() => {
    ...
    const debounce = setTimeout(async () => {
      ...
      try {
        ...
        for (const assetId of await searchTextChunksByKeywordAsync(searchQuery)) {
