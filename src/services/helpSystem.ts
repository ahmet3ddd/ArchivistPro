...
/**
 * Sürüm notlarını (CHANGELOG.md) yükler. Dil ayrımı yoktur — tek dosya
 * (`public/docs/CHANGELOG.md`). Bu dosya repo kökündeki `docs/CHANGELOG.md`'nin
 * predev/prebuild sırasında çoğaltılmış kopyasıdır (bkz. scripts/sync-docs.cjs).
 *
 * @throws Hata HTTP 404 veya network sorununda fırlatılır.
 */
